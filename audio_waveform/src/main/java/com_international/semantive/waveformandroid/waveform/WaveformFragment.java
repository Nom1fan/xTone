package com_international.semantive.waveformandroid.waveform;
...
import com_international.semantive.waveformandroid.R;
import com_international.semantive.waveformandroid.waveform.soundfile.CheapSoundFile;
import com_international.semantive.waveformandroid.waveform.view.MarkerView;
import com_international.semantive.waveformandroid.waveform.view.WaveformView;
...
public abstract class WaveformFragment extends Fragment implements MarkerView.MarkerListener, WaveformView.WaveformListener {
    ...
    public void markerTouchMove(MarkerView marker, float x) {
        ...
        int Startmiliseconds = mWaveformView.pixelsToMillisecs(mStartPos);
        int Endmiliseconds = mWaveformView.pixelsToMillisecs(mEndPos);
        ...
        if (marker == mStartMarker) {
            ...
            if (Startmiliseconds >= (Endmiliseconds - 1000)) {
                ...
                if(mEndPos <= mMaxPos)
                    mEndPos = mStartPos + mWaveformView.millisecsToPixels(1000);
            ...
            if (Startmiliseconds >= (Endmiliseconds)) {
                ...
                if (mStartPos != 0)
                    mStartPos = mEndPos - mWaveformView.millisecsToPixels(1000);
            }
