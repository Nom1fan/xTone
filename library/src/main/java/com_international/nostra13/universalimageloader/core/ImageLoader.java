 ...
 *******************************************************************************/
package com_international.nostra13.universalimageloader.core;
...
import com_international.nostra13.universalimageloader.cache.disc.DiskCache;
import com_international.nostra13.universalimageloader.cache.memory.MemoryCache;
import com_international.nostra13.universalimageloader.core.assist.FailReason;
import com_international.nostra13.universalimageloader.core.assist.FlushedInputStream;
import com_international.nostra13.universalimageloader.core.assist.ImageSize;
import com_international.nostra13.universalimageloader.core.assist.LoadedFrom;
import com_international.nostra13.universalimageloader.core.assist.ViewScaleType;
import com_international.nostra13.universalimageloader.core.imageaware.ImageAware;
import com_international.nostra13.universalimageloader.core.imageaware.ImageViewAware;
import com_international.nostra13.universalimageloader.core.imageaware.NonViewAware;
import com_international.nostra13.universalimageloader.core.listener.ImageLoadingListener;
import com_international.nostra13.universalimageloader.core.listener.ImageLoadingProgressListener;
import com_international.nostra13.universalimageloader.core.listener.SimpleImageLoadingListener;
import com_international.nostra13.universalimageloader.utils.ImageSizeUtils;
import com_international.nostra13.universalimageloader.utils.L;
import com_international.nostra13.universalimageloader.utils.MemoryCacheUtils;
...
public class ImageLoader {
	...
	public void displayImage(String uri,Bitmap bitmap, ImageAware imageAware, DisplayImageOptions options,
							 ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		displayImage(uri, bitmap,imageAware, options, null, listener, progressListener);
	}
	...
	public void displayImage(String uri,Bitmap bitmap, ImageAware imageAware, DisplayImageOptions options,
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			options.getDisplayer().display(bitmap, imageAware, LoadedFrom.NETWORK);
	...
	public void displayImage(String uri,Bitmap bitmap, ImageView imageView, DisplayImageOptions options,
							 ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		displayImage(uri, bitmap,new ImageViewAware(imageView), options, listener, progressListener);
	}
