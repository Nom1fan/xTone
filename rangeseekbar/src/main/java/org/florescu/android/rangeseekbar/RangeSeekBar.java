...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
      ...
      //      if (getSelectedMinValue() instanceof Long && getSelectedMaxValue() instanceof Long) {
                minText = String.valueOf(ConvertSecondsToHMmSs((Integer) getSelectedMinValue()));
                maxText = String.valueOf(ConvertSecondsToHMmSs((Integer)getSelectedMaxValue()));
         /*   } else {
    ...
    private String ConvertSecondsToHMmSs(Integer millis) {
