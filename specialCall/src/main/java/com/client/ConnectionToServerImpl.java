...
public class ConnectionToServerImpl implements ConnectionToServer  {

    private static final String TAG = ConnectionToServerImpl.class.getSimpleName();
     ...
     */
    public ConnectionToServerImpl(Type responseType) {
        this.responseType = responseType;
        gson = new Gson();
    }

    public ConnectionToServerImpl() {
        gson = new Gson();
    }
