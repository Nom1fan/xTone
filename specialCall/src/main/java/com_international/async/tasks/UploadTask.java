...
import com_international.client.ProgressListener;
import com_international.client.ProgressiveEntity;
...
import com_international.flows.PostUploadFileFlowLogic;
import com.google.gson.Gson;
import com_international.mediacallz.app.R;
import com_international.model.request.UploadFileRequest;
...
public class UploadTask extends AsyncTask<Void, Integer, Void> implements ProgressListener {
    ...
    public UploadTask(Context context, Bundle bundle, PostUploadFileFlowLogic postUploadFileFlowLogic) {
        ...
        this.bundle = bundle;
        fileForUpload = (MediaFile) bundle.get(KeysForBundle.FILE_FOR_UPLOAD);
    ...
    private String prepareDataForUpload(Bundle bundle) {
        ...
        uploadFileRequest.setDestinationId(bundle.get(KeysForBundle.DEST_ID).toString());
        uploadFileRequest.setDestinationContactName(bundle.get(KeysForBundle.DEST_NAME).toString());
        uploadFileRequest.setMediaFile(fileForUpload);
        uploadFileRequest.setFilePathOnSrcSd(fileForUpload.getFile().getAbsolutePath());
        uploadFileRequest.setSpecialMediaType((SpecialMediaType) bundle.get(KeysForBundle.SPEC_MEDIA_TYPE));
