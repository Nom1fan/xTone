...
import com_international.async.tasks.PopulateUrlsAsyncTask;
import com_international.data.objects.Constants;
import com_international.mediacallz.app.R;
import com_international.nostra13.universalimageloader.core.DisplayImageOptions;
...
import com_international.nostra13.universalimageloader.core.display.FadeInBitmapDisplayer;
import com_international.nostra13.universalimageloader.core.listener.SimpleImageLoadingListener;
import com_international.validate.media.ValidateImageFormatBehavior;
...
public class ImagePagerFragment extends BaseFragment implements PopulateUrlsAsyncTask.PostPopulateListener {
    ...
    public void constructPostPopulate(List<String> urls) {
        ...
        if(imageUrls == null || imageUrls.isEmpty()) {
            ...
            pager.setCurrentItem(getArguments().getInt(AbsListViewBaseFragment.MEDIA_POSITION, 0));
        }
    }
