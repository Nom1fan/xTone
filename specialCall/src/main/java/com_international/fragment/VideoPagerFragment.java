...
import com_international.validate.media.ValidateVideoFormatBehavior;
 ...
 */
public class VideoPagerFragment extends BaseFragment implements PopulateUrlsAsyncTask.PostPopulateListener {
    ...
    private void preparePager() {
        ...
        pager.setCurrentItem(getArguments().getInt(AbsListViewBaseFragment.MEDIA_POSITION));
