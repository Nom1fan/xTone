...
import com_international.client.DefaultMediaClient;
import com_international.converters.MediaDataConverter;
import com_international.dao.DAOFactory;
import com_international.dao.MediaDAO;
...
public class SyncOnDefaultMediaIntentServiceLogic {
    ...
    public void performSyncOnDefaultMedia() {
        ...
        try {
            syncOnDefaultMedia(SpecialMediaType.DEFAULT_CALLER_MEDIA);
            syncOnDefaultMedia(SpecialMediaType.DEFAULT_PROFILE_MEDIA);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
