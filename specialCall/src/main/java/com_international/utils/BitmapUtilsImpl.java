...
import com_international.async.tasks.BitMapWorkerTask;
...
public class BitmapUtilsImpl implements BitmapUtils {
    ...
    private static final String TAG = BitmapUtilsImpl.class.getSimpleName();
    ...
    @Override
    public void execBitmapWorkerTask(ImageView imageView, Context context, Resources resources, int resource, boolean makeRound) {
    ...
    @Override
    public void execBitMapWorkerTask(ImageView imageView, MediaFile.FileType fType, String filePath, boolean makeRound) {
    ...
    @Override
    public Bitmap decodeSampledBitmapFromImageFile(String filePath, int width, int height) {
    ...
    @Override
    public Bitmap decodeSampledBitmapFromImageFile(String filePath) {
    ...
    @Override
    public Bitmap transform(Bitmap bitmap, int radius, int margin) {
    ...
    @Override
    public Bitmap getImageBitmap(String filePath, int width, int height, boolean makeRound) {
    ...
    @Override
    public Bitmap getVideoBitmap(String filePath, int width, int height, boolean makeRound) {
    ...
    @Override
    public Bitmap createScaledBitMap(Bitmap bitmap, int width, int height, boolean makeRound) {
    ...
    @Override
    public Bitmap convertResourceToBitmap(Resources resources, int resourceId, int width, int height, boolean makeRound) {
